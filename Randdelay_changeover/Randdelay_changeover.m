...
if isempty(fieldnames(S))  % If settings file was an empty struct, populate struct with default settings
    ...
    S.GUI.Bridge            = 0;
    S.GUI.Drugs             = 0;
    S.GUI.LED1_Amp =2.6; %yellow
    S.GUI.LED2_Amp = 0.5; % blue
    S.GUI.LED1_Freq = 211;
    S.GUI.LED2_Freq = 531;
    S.GUI.Modulation=1;
...
%% Define trials
StartRewardLeft= shuffle(repmat(S.GUI.RewardAmount ,1,1550));
StartRewardRight= shuffle(repmat(S.GUI.RewardAmount,1,1550));
